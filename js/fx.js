d3.csv("data/fx.csv", cast, function(data) {
  ...
  var ubsvg = d3.select("#fxgraph").append("svg")
   ...
   fxrects = gymnast.selectAll("rect.fx")
    ...
    .enter().append("rect")
      ...
      .attr("class", function(d) {        
        ...
        return "bars fx class" + classLabel;
      })
  ...
  .property("disabled", true);
          d3.select(this)           
            ...
            d3.select("#fxlabel").select("#sortfx").property("disabled", false)
            d3.select("#fxlabel").style("color", "black")
            //sort the bars if checkbox is clicked            
            d3.select("#sortfx").on("change", function() {
              changevt(dataset)});  
          ...
          if (active_link === this.id.split("id").pop()) {//active square selected; turn it OFF
            ...
            if (d3.select("#fxlabel").select("#sortfx").property("checked")) {              
              restoreXFlag = true;
            }
  ...
  .property("disabled", false);
      //restore graph after a single selection
      d3.selectAll(".bars.fx:not(.class" + class_keep + ")")
            .transition()
            .duration(1000)
            .delay(function() {
      ...
      d3.selectAll(".fx.class" + class_keep)
    ...
    if ($('#sortfx').is(":checked")) sortDescending = true;
    ...
    gymnast.selectAll("fx.class" + active_link)
         .sort(function(a, b) { 
    ...
    //sort bars
    transition.selectAll(".fx.class" + active_link)
      .delay(delay)
      .attr("x", function(d) {      
    ...
    var fixxaxis = transition.select(".fx.x.axis")
        .call(vtxAxis)
    	.selectAll(".tick text")
